...
const dict = {
  en: {
    ...
    terms_agree: "By continuing you agree to AndiPark's Terms and Privacy Policy.",
    // Settings
    settings: "Settings",
    ...
    analytics: "Analytics", analytics_hint: "Help us improve AndiPark",
    ...
    notif_sound: "Notification sound", notif_sound_hint: "Play a chime for new alerts",
    test_sound: "Play test sound",
    how_it_works: "How AndiPark works",
    how1_t: "Find a spot", how1_d: "Live parking around you on the map.",
    how2_t: "Share your exit", how2_d: "Pin your spot and pick when you leave.",
    how3_t: "Hand over & earn", how3_d: "Every successful handoff earns points.",
    invite_applied_title: "Invite link detected",
    invite_applied_desc: "You'll get 100 bonus points after sign-up with code",
  ...
  ar: {
    ...
    terms_agree: "بمتابعتك فأنت توافق على شروط AndiPark وسياسة الخصوصية.",
    settings: "الإعدادات",
    ...
    analytics: "التحليلات", analytics_hint: "ساعدنا في تحسين AndiPark",
    ...
    notif_sound: "صوت الإشعارات", notif_sound_hint: "تشغيل نغمة عند وصول إشعار",
    test_sound: "تجربة الصوت",
    how_it_works: "كيف يعمل AndiPark",
    how1_t: "ابحث عن موقف", how1_d: "المواقف المتاحة حولك مباشرة على الخريطة.",
    how2_t: "شارك وقت خروجك", how2_d: "ثبّت موقفك واختر وقت مغادرتك.",
    how3_t: "سلّم واربح", how3_d: "كل عملية تسليم ناجحة تمنحك نقاطًا.",
    invite_applied_title: "تم اكتشاف رابط دعوة",
    invite_applied_desc: "ستحصل على 100 نقطة إضافية بعد التسجيل بالرمز",
