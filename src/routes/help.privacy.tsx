...
export const Route = createFileRoute("/help/privacy")({ component: () => (
  <Screen title="Privacy policy" back="/help">
    <article className="prose prose-sm max-w-none space-y-3 text-sm text-foreground/90">
      <p>AndiPark respects your privacy. We collect only what's needed to help you share and find parking.</p>
      ...
      <p>We never sell your data. We share only with service providers essential to running AndiPark.</p>
